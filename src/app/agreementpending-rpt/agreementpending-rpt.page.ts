...
@Component({
  selector: 'app-agreementpending-rpt',
  templateUrl: './agreementpending-rpt.page.html',
  styleUrls: ['./agreementpending-rpt.page.scss'],
})
export class AgreementpendingRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'agreementpending_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/agreementpending_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/agreementpending_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
