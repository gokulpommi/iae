...
@Component({
  selector: 'app-croppurchase-rpt',
  templateUrl: './croppurchase-rpt.page.html',
  styleUrls: ['./croppurchase-rpt.page.scss'],
})
export class CroppurchaseRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/croppurchase_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/croppurchase_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
