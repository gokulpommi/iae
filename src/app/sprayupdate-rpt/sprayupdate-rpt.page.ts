...
@Component({
  selector: 'app-sprayupdate-rpt',
  templateUrl: './sprayupdate-rpt.page.html',
  styleUrls: ['./sprayupdate-rpt.page.scss'],
})
export class SprayupdateRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/sprayupdate_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/sprayupdate_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
