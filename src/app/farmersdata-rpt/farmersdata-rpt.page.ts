...
@Component({
  selector: 'app-farmersdata-rpt',
  templateUrl: './farmersdata-rpt.page.html',
  styleUrls: ['./farmersdata-rpt.page.scss'],
})
export class FarmersdataRptPage implements OnInit {
  ...
  ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/farmersdata_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/farmersdata_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
