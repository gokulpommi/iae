...
@Component({
  selector: 'app-frmsummary-rpt',
  templateUrl: './frmsummary-rpt.page.html',
  styleUrls: ['./frmsummary-rpt.page.scss'],
})
export class FrmsummaryRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/frmsummary_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/frmsummary_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
