...
@Component({
  selector: 'app-faqdetails-rpt',
  templateUrl: './faqdetails-rpt.page.html',
  styleUrls: ['./faqdetails-rpt.page.scss'],
})
export class FaqdetailsRptPage implements OnInit { 
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/faqdetails_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/faqdetails_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
