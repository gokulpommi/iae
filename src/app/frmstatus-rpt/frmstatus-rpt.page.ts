...
@Component({
  selector: 'app-frmstatus-rpt',
  templateUrl: './frmstatus-rpt.page.html',
  styleUrls: ['./frmstatus-rpt.page.scss'],
})
export class FrmstatusRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'frmbookingstatusupdate_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/frmbookingstatusupdate_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/frmbookingstatusupdate_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
