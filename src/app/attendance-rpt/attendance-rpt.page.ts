...
@Component({
  ...
  templateUrl: './attendance-rpt.page.html',
  styleUrls: ['./attendance-rpt.page.scss'],
})
export class AttendanceRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'attendancereport_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/attendancereport_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/attendancereport_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
