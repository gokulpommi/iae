...
@Component({
  selector: 'app-farmerappmanager-rpt',
  templateUrl: './farmerappmanager-rpt.page.html',
  styleUrls: ['./farmerappmanager-rpt.page.scss'],
})
export class FarmerappmanagerRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'farmerappmanager_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/farmerappmanager_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/farmerappmanager_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
