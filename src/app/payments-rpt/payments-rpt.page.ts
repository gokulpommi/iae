...
@Component({
  selector: 'app-payments-rpt',
  templateUrl: './payments-rpt.page.html',
  styleUrls: ['./payments-rpt.page.scss'],
})
export class PaymentsRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/payments_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/payments_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
