...
@Component({
  selector: 'app-returns-rpt',
  templateUrl: './returns-rpt.page.html',
  styleUrls: ['./returns-rpt.page.scss'],
})
export class ReturnsRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/returns_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/returns_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
