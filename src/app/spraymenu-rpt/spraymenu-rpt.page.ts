...
@Component({
  selector: 'app-spraymenu-rpt',
  templateUrl: './spraymenu-rpt.page.html',
  styleUrls: ['./spraymenu-rpt.page.scss'],
})
export class SpraymenuRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/spraymenu_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/spraymenu_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
