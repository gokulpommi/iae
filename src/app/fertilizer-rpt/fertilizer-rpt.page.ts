...
@Component({
  selector: 'app-fertilizer-rpt',
  templateUrl: './fertilizer-rpt.page.html',
  styleUrls: ['./fertilizer-rpt.page.scss'],
})
export class FertilizerRptPage implements OnInit {
  ...
  ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/fertilizer_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/fertilizer_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
