...
@Component({
  selector: 'app-farmerapp-rpt',
  templateUrl: './farmerapp-rpt.page.html',
  styleUrls: ['./farmerapp-rpt.page.scss'],
})
export class FarmerappRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/farmerapp_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/farmerapp_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
