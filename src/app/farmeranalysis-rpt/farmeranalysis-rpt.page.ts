...
@Component({
  selector: 'app-farmeranalysis-rpt',
  templateUrl: './farmeranalysis-rpt.page.html',
  styleUrls: ['./farmeranalysis-rpt.page.scss'],
})
export class FarmeranalysisRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'farmeranalysis_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/farmeranalysis_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/farmeranalysis_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
