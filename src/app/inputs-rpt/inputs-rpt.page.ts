...
@Component({
  selector: 'app-inputs-rpt',
  templateUrl: './inputs-rpt.page.html',
  styleUrls: ['./inputs-rpt.page.scss'],
})
export class InputsRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/inputs_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/inputs_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
