...
@Component({
  selector: 'app-statuspendingupdate-rpt',
  templateUrl: './statuspendingupdate-rpt.page.html',
  styleUrls: ['./statuspendingupdate-rpt.page.scss'],
})
export class StatuspendingupdateRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'statusupdatepending_rpt';
  ...
  ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/statusupdatepending_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/statusupdatepending_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
