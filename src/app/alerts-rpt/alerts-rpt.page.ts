...
@Component({
  selector: 'app-alerts-rpt',
  templateUrl: './alerts-rpt.page.html',
  styleUrls: ['./alerts-rpt.page.scss'],
})
export class AlertsRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/alerts_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/alerts_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
