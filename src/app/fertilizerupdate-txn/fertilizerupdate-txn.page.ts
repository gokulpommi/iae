...
@Component({
  selector: 'app-fertilizerupdate-txn',
  templateUrl: './fertilizerupdate-txn.page.html',
  styleUrls: ['./fertilizerupdate-txn.page.scss'],
})
export class FertilizerupdateTxnPage implements OnInit {
  ...
  constructor( 
    ...
    this.jsonUrl = 'assets/json/fertilizerupdate_txn.json';
  ...
  async ionViewDidEnter(){
       ...
       let elements:any;
        ...
        try {
          const data = await this.http.get('assets/json/fertilizerupdate_txn.json').toPromise();
