...
@Component({
  selector: 'app-farmmstone-txn',
  templateUrl: './farmmstone-txn.page.html',
  styleUrls: ['./farmmstone-txn.page.scss'],
})
export class FarmmstoneTxnPage implements OnInit {
  ...
  constructor( 
    ...
    this.jsonUrl = 'assets/json/farmmstone_txn.json';
  ...
  async ionViewDidEnter(){
        ...
        try {
          const data = await this.http.get('assets/json/farmmstone_txn.json').toPromise();
