...
@Component({
  selector: 'app-sprayactivities-txn',
  templateUrl: './sprayactivities-txn.page.html',
  styleUrls: ['./sprayactivities-txn.page.scss'],
})
export class SprayactivitiesTxnPage implements OnInit {
  ...
  constructor( 
    ...
    this.jsonUrl = 'assets/json/sprayactivities_txn.json';
  ...
  async ionViewDidEnter(){
        ...
        try {
          const data = await this.http.get('assets/json/sprayactivities_txn.json').toPromise();
