...
@Component({
  selector: 'app-alerttype-txn',
  templateUrl: './alerttype-txn.page.html',
  styleUrls: ['./alerttype-txn.page.scss'],
})
export class AlerttypeTxnPage implements OnInit {
  ...
  constructor( 
    ...
    this.jsonUrl = 'assets/json/alerttype_txn.json';
  ...
  async ionViewDidEnter(){
        ...
        try {
          const data = await this.http.get('assets/json/alerttype_txn.json').toPromise();
