...
@Component({
  selector: 'app-faq-rpt',
  templateUrl: './faq-rpt.page.html',
  styleUrls: ['./faq-rpt.page.scss'],
})
export class FaqRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/faq_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/faq_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
