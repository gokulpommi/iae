...
@Component({
  selector: 'app-alertmenu-rpt',
  templateUrl: './alertmenu-rpt.page.html',
  styleUrls: ['./alertmenu-rpt.page.scss'],
})
export class AlertmenuRptPage implements OnInit {
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/alertmenu_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/alertmenu_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
