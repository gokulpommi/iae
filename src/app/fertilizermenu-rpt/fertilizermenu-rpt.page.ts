...
@Component({
  selector: 'app-fertilizermenu-rpt',
  templateUrl: './fertilizermenu-rpt.page.html',
  styleUrls: ['./fertilizermenu-rpt.page.scss'],
})
export class FertilizermenuRptPage implements OnInit {
  ...
  constructor( 
        ...
        this.rptName = 'fertilizermenu_rpt';
  ...
  ngOnInit() {  }
   ...
   ionViewDidEnter() {
    ...
    this.jsonUrl = 'assets/json/fertilizermenu_rpt.json';
        //this.http.get('assets/json/farmerapp_rpt.json').map(res => res.json()).subscribe(data => {
          this.http.get('assets/json/fertilizermenu_rpt.json', {responseType: 'json'}).subscribe((data:any) => {
           console.log(data);
            this.subtitles = data;
