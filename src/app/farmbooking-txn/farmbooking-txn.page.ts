...
@Component({
  selector: 'app-farmbooking-txn',
  templateUrl: './farmbooking-txn.page.html',
  styleUrls: ['./farmbooking-txn.page.scss'],
  
})
export class FarmbookingTxnPage implements OnInit {
  ...
  constructor( 
    ...
    this.jsonUrl = 'assets/json/frmbooking_txn.json';
